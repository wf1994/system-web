 ...
 * @Descripttion: 
 * @Author: zxy
 * @Date: 2020-12-03 16:16:34
 * @LastEditTime: 2020-12-03 16:19:55
-->
<template>
    ...
    return {
      ...
      option: {
        globe: {
          ...
          silent: true,
          environment: require('../../public/resources/earth/earthBackground.jpg'), //背景
          heightTexture: require('../../public/resources/earth/earth.jpg'), //地球的整个纹路
          shading: 'realistic',
          light: {
            main: {
              color: '#fff',
